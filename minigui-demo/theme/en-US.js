module.exports = {
  ...
  'app.home.components-explain':
    'Based on the Minigui Vue language, we have provided a suite of out-of-the-box with high quality for developing and serving enterprise background applications,including the official React implementation and Angular, Vue implementations',
  'app.home.product-pro-slogan': 'Out-of-the-box front-end / Design solution',
  'app.home.product-mobile-slogan':
    "minigui-mobile is the implementation of Minigui Vue's mobile specification",
  'app.home.product-landing-slogan':
    'Landing Pages templates and specifications based of Minigui Vue language',
  'app.home.product-minigui-slogan':
    'Simple, professional, with unlimited possibilities for data visualization solutions',
  'app.home.tool-title': 'Tools & Resources',
  'app.home.tool-package-title': 'Minigui Vue Resources',
  'app.home.tool-package-content': 'Minigui Vue Resources Download',
  ...
  'app.home.more-mobile-react': 'Minigui Vue Mobile of React',
  'app.home.more-mobile-angular': 'Minigui Vue Mobile of Angular',
  'app.footer.repo': 'GitHub Repository',
  'app.footer.awesome': 'Awesome Minigui Vue',
  'app.footer.course': 'Minigui Vue Practical Tutorial',
  ...
  'app.footer.minigui-library': 'Axure library',
  'app.footer.minigui': 'Sitemap Template',
