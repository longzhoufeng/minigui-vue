module.exports = {
  ...
  'app.home.components-explain':
    '基于 Minigui Vue 设计语言，我们提供了开箱即用的高质量 React 和 Angular 组件实现，用于开发和服务于企业级中后台产品。',
  'app.home.product-pro-slogan': '开箱即用的中台前端/设计解决方案',
  'app.home.product-mobile-slogan': 'minigui-mobile 是 Minigui Vue 移动规范的实现',
  'app.home.product-minigui-slogan': '简单、专业、拥有无限可能的数据可视化解决方案',
  'app.home.product-landing-slogan': '基于 Minigui Vue 设计语言的 Landing 模板与规范',
  'app.home.tool-title': '工具和资源',
  'app.home.tool-package-title': 'Minigui Vue 资源包',
  'app.home.tool-package-content': 'Minigui Vue 相关设计资源下载',
  ...
  'app.footer.course': 'Minigui Vue 实战教程',
  ...
  'app.footer.minigui-library': 'Axure 部件库',
  'app.footer.design-resources': '设计资源下载',
  'app.footer.minigui': '页面逻辑素材',
